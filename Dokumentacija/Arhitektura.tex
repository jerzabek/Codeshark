\chapter{Arhitektura i dizajn sustava}
	...
	\end{itemize}
		...
		\begin{longtblr}[
			...
			VrijemeKraj	& DATE & vrijeme završetka natjecanja 	\\ \hline 
			VrijemePoc & DATE	&  vrijeme početka natjecanje		\\ \hline 
		...
		\begin{longtblr}[
			...
			Privatnost & INT	&  binarna vrijednost privatnosti( 1-zadatak je javan, 0-zadatak je privatan)	\\ \hline 
		...
		\begin{longtblr}[
			...
			\SetCell{LightGreen}Vrijeme Predaje & DATE	&  vrijeme predaje rješenja  	\\ \hline
			...
			NatjecanjeTraje & INT & binarna vrijednost trajanja natjecanje(1-natjecanje trenutno traje,0-natjecanje trenutno ne traje)  \\ \hline  
		\end{longtblr}
